...
// Reads cart from CartContext (filled by BookList via addToCart); no API calls here
const CartPage = () => {
                ...
                <div className="card-body p-4">
                    {cart.length === 0 ? (
                        <div className="text-center py-5">
                            ...
                            {/* Goes back in history — usually returns to books with sessionStorage still intact */}
